...
public class OpenPixelmonItems implements ModInitializer {
    ...
    public static final Item RARE_CANDY = createItem("rare_candy", ItemGroups.RESTORATION);
    public static final Item DYNAMAX_CANDY = createItem("dynamax_candy", ItemGroups.RESTORATION);
    public static final Item POTION = createItem("potion", ItemGroups.RESTORATION);
    public static final Item SUPER_POTION = createItem("super_potion", ItemGroups.RESTORATION);
    public static final Item HYPER_POTION = createItem("hyper_potion", ItemGroups.RESTORATION);
    public static final Item MAX_POTION = createItem("max_potion", ItemGroups.RESTORATION);
    public static final Item FRESH_WATER = createItem("fresh_water", ItemGroups.RESTORATION);
    public static final Item SODA_POP = createItem("soda_pop", ItemGroups.RESTORATION);
    public static final Item LEMONADE = createItem("lemonade", ItemGroups.RESTORATION);
    public static final Item MOOMOO_MILK = createItem("moomoo_milk", ItemGroups.RESTORATION);
    public static final Item ETHER = createItem("ether", ItemGroups.RESTORATION);
    public static final Item MAX_ETHER = createItem("max_ether", ItemGroups.RESTORATION);
    public static final Item ELIXIR = createItem("elixir", ItemGroups.RESTORATION);
    public static final Item MAX_ELIXIR = createItem("max_elixir", ItemGroups.RESTORATION);
    public static final Item FULL_RESTORE = createItem("full_restore", ItemGroups.RESTORATION);
    public static final Item REVIVE = createItem("revive", ItemGroups.RESTORATION);
    public static final Item MAX_REVIVE = createItem("max_revive", ItemGroups.RESTORATION);
    public static final Item ANTIDOTE = createItem("antidote", ItemGroups.RESTORATION);
    public static final Item PARALYZE_HEAL = createItem("paralyze_heal", ItemGroups.RESTORATION);
    public static final Item AWAKENING = createItem("awakening", ItemGroups.RESTORATION);
    public static final Item BURN_HEAL = createItem("burn_heal", ItemGroups.RESTORATION);
    public static final Item ICE_HEAL = createItem("ice_heal", ItemGroups.RESTORATION);
    public static final Item FULL_HEAL = createItem("full_heal", ItemGroups.RESTORATION);
    public static final Item HP_UP = createItem("hp_up", ItemGroups.RESTORATION);
    ...
    public static final Item POMEG_BERRY = createItem("pomeg_berry", ItemGroups.RESTORATION);
    public static final Item KELPSY_BERRY = createItem("kelpsy_berry", ItemGroups.RESTORATION);
    public static final Item QUALOT_BERRY = createItem("qualot_berry", ItemGroups.RESTORATION);
    public static final Item HONDEW_BERRY = createItem("hondew_berry", ItemGroups.RESTORATION);
    public static final Item GREPA_BERRY = createItem("grepa_berry", ItemGroups.RESTORATION);
    public static final Item TAMATO_BERRY = createItem("tamato_berry", ItemGroups.RESTORATION);
    public static final Item HEAL_POWDER = createItem("heal_powder", ItemGroups.RESTORATION);
